\include{preamble}											% Preamble indlaeses
...
\include{system/beskrivelse}
\include{system/processor}


%% Teknisk %%
\include{teknisk/metode}
\include{teknisk/gitter}
%\include{teknisk/konvgitter}
%\include{teknisk/radiation}
%\include{teknisk/heatpipe}
%\include{teknisk/konvpipe}
%% Afrunding %%

\include{teknisk/konklusion}
\include{teknisk/litteratur}
%\include{appendiks/beregninger}
